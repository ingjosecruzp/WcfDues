...
namespace WcfDues
{
    ...
    public partial class OCRD
    {
        ...
        public string U_Agente { get; set; }
        public string U_Ejecutivo { get; set; }
        public string U_CODIGO { get; set; }
        public string U_BXP_EINV { get; set; }
        public string U_BXP_Addenda { get; set; }
        public string U_Metodo_de_pago { get; set; }
        public string U_Cuenta { get; set; }
        public string U_Metodo_de_pago_2 { get; set; }
        public string U_cuenta_2 { get; set; }
        public string U_Cuenta_Bancaria { get; set; }
        public string U_Codigo_BancoSN { get; set; }
        public string U_BOY_23_QCCS { get; set; }
        public string U_BOY_23_ADPRTCD { get; set; }
        public string U_BOY_TB_0 { get; set; }
        public string U_TipoProveedor { get; set; }
        public string U_TiempoEntrega { get; set; }
        public string U_Procedencia { get; set; }
        public string U_TipoTextil { get; set; }
        public string U_FormaPago { get; set; }
        public string U_EfectividadFallas { get; set; }
    }
}
