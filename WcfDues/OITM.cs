...
namespace WcfDues
{
    ...
    public partial class OITM
    {
        ...
        public string U_CODVT { get; set; }
        public string U_CODCP { get; set; }
        public string U_CODUE { get; set; }
        public string U_COLOR { get; set; }
        public string U_COMP { get; set; }
        public string U_CODCS { get; set; }
        public string U_COBAS { get; set; }
        public string U_Act { get; set; }
        public string U_BXP_DUN14 { get; set; }
        public string U_BXP_CodintCop { get; set; }
        public string U_SubGrupo { get; set; }
        public string U_DD_NOMBRES { get; set; }
        public string U_DD_PRODUCTOS { get; set; }
        public string U_DD_ARTICULO { get; set; }
        public string U_DD_ACTIVO { get; set; }
        public string U_DD_TIPO_BASTON { get; set; }
        public string U_DD_TIPO_TELA { get; set; }
        public string U_DD_REMATE { get; set; }
        public string U_DD_FIJACION { get; set; }
        public string U_DD_SOPORTE { get; set; }
        public string U_DD_SISTEMA { get; set; }
        public string U_DD_DECORATIVO { get; set; }
        public string U_DD_ARGOLLA { get; set; }
        public string U_DD_VARILLA { get; set; }
        public string U_DD_FORRO { get; set; }
        public string U_DD_ANCHO { get; set; }
        public string U_DD_ALTO { get; set; }
        public string U_DD_PESO { get; set; }
        public string U_DD_PEDIDO { get; set; }
        public string U_DD_COLOR { get; set; }
        public string U_DD_RAPPORT { get; set; }
        public string U_DD_RAPPORT_HOR { get; set; }
        public string U_DD_RAPPORT_VERT { get; set; }
        public string U_DD_RAPPORT_PLOMO { get; set; }
        public string U_CodigoIntAmazon { get; set; }
        public string U_ItemEstado { get; set; }
        public string U_ItemDeLinea { get; set; }
        public string U_ItemComposicion { get; set; }
        public string U_ItemTejido { get; set; }
        public string U_ItemCaracteristica { get; set; }
        public string U_ItemMinimoCompra { get; set; }
        public string U_ItemRapport { get; set; }
        public string U_CE_M_NoIdentifica { get; set; }
        public string U_CE_M_FArancelaria { get; set; }
        public string U_CE_M_Cantidad { get; set; }
        public string U_CE_M_UnidadAduana { get; set; }
        public string U_CE_M_ValorUnitario { get; set; }
        public string U_CE_M_ValorDolares { get; set; }
        public string U_CE_DESP_Marca { get; set; }
        public string U_CE_DESP_Modelo { get; set; }
        public string U_CE_DESP_Submodelo { get; set; }
        public string U_CE_DESP_NumSerie { get; set; }
        public string U_ST_ARTICULO { get; set; }
        public string U_ST_DETALLE { get; set; }
        public string U_ST_MEDIDA { get; set; }
        public string U_ST_CALCULO { get; set; }
        public string U_ST_ANCHO { get; set; }
        public string U_ST_ALTO { get; set; }
        public string U_ST_TIPOTELA { get; set; }
        public string U_ST_COLOR { get; set; }
        public string U_ST_TIPOCLIENTE { get; set; }
        public string U_ST_ACTIVO { get; set; }
        public string U_ST_TIPO { get; set; }
        public string U_ST_LINEA { get; set; }
